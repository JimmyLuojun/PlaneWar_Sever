...
import pygame
from plane_war_server.game import main


class TestMain:
    """Tests for main function."""

    @patch('plane_war_server.game.main.run_state_machine')
    @patch('plane_war_server.game.main.NetworkClient')
    @patch('plane_war_server.game.main.Background')
    @patch('plane_war_server.game.main.utils.load_high_score', return_value=1000)
    @patch('plane_war_server.game.main.load_level_data_and_music')
    @patch('plane_war_server.game.main.load_sounds')
    @patch('plane_war_server.game.main.load_images')
    @patch('plane_war_server.game.main.load_fonts')
    ...
    @patch('plane_war_server.game.main.NetworkClient')
    @patch('plane_war_server.game.main.Background')
    @patch('plane_war_server.game.main.utils.load_high_score', return_value=0)
    @patch('plane_war_server.game.main.load_level_data_and_music')
    @patch('plane_war_server.game.main.load_sounds')
    @patch('plane_war_server.game.main.load_images')
    @patch('plane_war_server.game.main.load_fonts')
    ...
    @patch('plane_war_server.game.main.NetworkClient')
    @patch('plane_war_server.game.main.Background')
    @patch('plane_war_server.game.main.utils.load_high_score', return_value=5000)
    @patch('plane_war_server.game.main.load_level_data_and_music')
    @patch('plane_war_server.game.main.load_sounds')
    @patch('plane_war_server.game.main.load_images')
    @patch('plane_war_server.game.main.load_fonts')
    ...
    @patch('plane_war_server.game.main.NetworkClient')
    @patch('plane_war_server.game.main.Background')
    @patch('plane_war_server.game.main.utils.load_high_score', return_value=2500)
    @patch('plane_war_server.game.main.load_level_data_and_music')
    @patch('plane_war_server.game.main.load_sounds')
    @patch('plane_war_server.game.main.load_images')
    @patch('plane_war_server.game.main.load_fonts')
